    ...
    <div class="container-scroller">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          <ul class="navbar-nav mr-lg-2">
            <li class="nav-item  d-none d-lg-flex">
              <a class="nav-link" href="pantallaLoginAdmin.php">
                INICIO
              </a>
            </li>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/forms/altasAdmin.php">
              <i class="typcn typcn-device-desktop menu-icon"></i>
              <span class="menu-title">Altas </span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link"  href="pages/forms/ventasAdmin.php" >
          ...
          <li class="nav-item">
          <a class="nav-link" href="pages/forms/pantallaProductosAdmin.php">
