...
<button id="boton" class="botoni">
    ...
    <div id="dialogo" class="barra-lateral">
        <p>ada</p>
        <p><a href="backend/volver_menuAvan.php">inicio</a></p>
...
<div class="botonesPan">
        ...
        <div id="modalAgregarProducto" class="modal">
            <div class="modal-content">
                ...
                <form id="formAgregarProducto" action="backend/registro_productoAvan.php" method="POST">
...
<div id="modalModificarProducto" class="modal" style="display: none;">
    <div class="modal-content">
        ...
        <form id="formModificarProducto" action="backend/modificar_productosAvan.php" method="POST">
